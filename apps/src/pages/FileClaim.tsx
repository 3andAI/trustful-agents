...
export default function FileClaim() {
  ...
  useEffect(() => {
    if (requiredDeposit && allowance !== undefined) {
      setNeedsApproval(allowance < requiredDeposit)
    }
  ...
  // After claim succeeds, redirect to dashboard
  useEffect(() => {
    if (claimSuccess) {
      navigate('/')
    }
  ...
  // Hash evidence file when selected
  useEffect(() => {
    if (evidenceFile) {
        ...
        <div className="card p-6 space-y-6">
          <div>
            ...
            <div className="space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium text-surface-300 mb-2">
                  Or provide Evidence URI (IPFS/HTTP)
                </label>
                <input
                  type="text"
                  value={evidenceUri}
                ...
                />
                <p className="text-xs text-surface-500 mt-1">
                  If you have already uploaded your evidence to IPFS or a web server, enter the URL here
                </p>
              </div>
            ...
            <div className="space-y-4">
              <div className="p-4 bg-surface-800 rounded-lg border border-surface-700">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    <p className="font-medium text-surface-100">Approve USDC</p>
                    <p className="text-sm text-surface-400">
                      Allow ClaimsManager to use ${formatUSDC(requiredDeposit || BigInt(0))} USDC
                    </p>
                  </div>
                </div>
                <button
              ...
              <div className="p-4 bg-surface-800/50 rounded-lg border border-surface-700/50 opacity-50">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-medium text-surface-400">File Claim</p>
                    <p className="text-sm text-surface-500">
            ...
            <div className="space-y-4">
              <div className="p-4 bg-surface-800 rounded-lg border border-accent/30">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    <p className="font-medium text-surface-100">USDC Approved</p>
                    <p className="text-sm text-surface-400">
              ...
              <div className="p-4 bg-surface-800 rounded-lg border border-surface-700">
                ...
                >
                  {claimPending || claimConfirming ? (
                    <>
                      <Loader2 className="w-4 h-4 mr-2 animate-spin" />
                      {claimPending ? 'Confirm in wallet...' : 'Filing claim...'}
                    </>
                  ) : (
                    'File Claim'
                  )}
