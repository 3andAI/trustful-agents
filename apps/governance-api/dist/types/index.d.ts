...
export type AuditAction = 'council_created' | 'council_closed' | 'council_updated' | 'member_added' | 'member_removed' | 'member_metadata_updated' | 'agent_reassigned' | 'safe_tx_proposed' | 'safe_tx_signed' | 'safe_tx_executed';
export type TargetType = 'council' | 'member' | 'agent' | 'safe_tx';
export type EmailTemplate = 'council_deletion_proposed' | 'council_deleted' | 'council_deletion_rejected' | 'member_added' | 'member_removed' | 'vote_required';
