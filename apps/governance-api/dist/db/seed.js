...
async function seed() {
    ...
    for (const signer of signers) {
        await query(`INSERT INTO governance_signers (address, name, email)
       VALUES ($1, $2, $3)
       ON CONFLICT (address) DO UPDATE SET name = $2, email = $3`, [signer.address.toLowerCase(), signer.name, signer.email]);
    }
    ...
    for (const member of members) {
        await query(`INSERT INTO council_members (address, council_id, name, description, email)
       VALUES ($1, $2, $3, $4, $5)
